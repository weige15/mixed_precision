...
triton_red_fused__to_copy_add_embedding_gptq_gemm_mean_mul_pow_rsqrt_0 = async_compile.triton('triton_red_fused__to_copy_add_embedding_gptq_gemm_mean_mul_pow_rsqrt_0', '''
import triton
...
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_embedding_gptq_gemm_mean_mul_pow_rsqrt_0.run(arg0_1, arg2_1, arg3_1, buf0, buf2, 8192, 4096, stream=stream0)
del arg0_1, arg2_1, arg3_1, buf0, buf2

stream0 = get_raw_stream(0)
buf4 = generate_example_value((8192, 6144), (6144, 1), 'cuda:0', torch.float16, 0, (8192, 6144))
arg8_1 = generate_example_value((8192,), (1,), 'cuda:0', torch.int64, 0, (8192,))
arg9_1 = generate_example_value((131072, 128), (128, 1), 'cuda:0', torch.float16, 0, (131072, 128))
buf5 = generate_example_value((8192, 32, 128), (4096, 128, 1), 'cuda:0', torch.float16, 0, (8192, 32, 128))
buf6 = generate_example_value((8192, 8, 128), (1024, 128, 1), 'cuda:0', torch.float16, 0, (8192, 8, 128))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_1.run(buf4, arg8_1, arg9_1, buf5, buf6, 33554432, 8388608, stream=stream0)
del buf4, arg8_1, arg9_1, buf5, buf6
...
# kernel path: /nfs/home/s314511048/mixed_precision/torchinductor_s314511048/ua/cua6w26vywoadx2khjvuluiqep6xyznfrlhfr6kahxord6f5hl44.py
# Topologically Sorted Source Nodes: [long, embedding, to, pow_1, mean, add, rsqrt, mul, to_1, mul_1, gptq_gemm], Original ATen: [aten._to_copy, aten.embedding, aten.pow, aten.mean, aten.add, aten.rsqrt, aten.mul, _C.gptq_gemm]
...
#   %gptq_gemm : Tensor "f16[s72, 6144][6144, 1]cuda:0"[num_users=1] = call_function[target=torch.ops._C.gptq_gemm.default](args = (%mul_15, %arg4_1, %arg5_1, %arg6_1, %arg7_1, True, False, 4), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg4_1, (512, 6144), (6144, 1))
        assert_size_stride(arg5_1, (32, 768), (768, 1))
        assert_size_stride(arg6_1, (32, 6144), (6144, 1))
        assert_size_stride(arg8_1, (s72, ), (1, ))
        assert_size_stride(arg9_1, (131072, 128), (128, 1))
        _xnumel = 4096*s72
        _xnumel = 1024*s72
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            ...
            # Topologically Sorted Source Nodes: [long, embedding, to, pow_1, mean, add, rsqrt, mul, to_1, mul_1, gptq_gemm], Original ATen: [aten._to_copy, aten.embedding, aten.pow, aten.mean, aten.add, aten.rsqrt, aten.mul, _C.gptq_gemm]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_embedding_gptq_gemm_mean_mul_pow_rsqrt_0.run(arg0_1, arg2_1, arg3_1, buf0, buf2, s72, 4096, stream=stream0)
            del arg0_1
            del arg2_1
            del arg3_1
            # Topologically Sorted Source Nodes: [to, pow_1, mean, add, rsqrt, mul, to_1, mul_1, gptq_gemm], Original ATen: [aten._to_copy, aten.pow, aten.mean, aten.add, aten.rsqrt, aten.mul, _C.gptq_gemm]
            buf3 = torch.ops._C.gptq_gemm.default(buf2, arg4_1, arg5_1, arg6_1, arg7_1, True, False, 4)
            del arg4_1
            del arg5_1
            del arg6_1
            del arg7_1
            del buf2
            buf4 = buf3
            assert_size_stride(buf4, (s72, 6144), (6144, 1), 'torch.ops._C.gptq_gemm.default')
            assert_alignment(buf4, 16, 'torch.ops._C.gptq_gemm.default')
            del buf3
            buf5 = empty_strided_cuda((s72, 32, 128), (4096, 128, 1), torch.float16)
            buf6 = empty_strided_cuda((s72, 8, 128), (1024, 128, 1), torch.float16)
            # Unsorted Source Nodes: [], Original ATen: []
            triton_poi_fused_1_xnumel_0 = 4096*s72
            triton_poi_fused_1_xnumel_1 = 1024*s72
            stream0 = get_raw_stream(0)
            triton_poi_fused_1.run(buf4, arg8_1, arg9_1, buf5, buf6, triton_poi_fused_1_xnumel_0, triton_poi_fused_1_xnumel_1, stream=stream0)
            del arg8_1
            del arg9_1
            buf7 = empty_strided_cuda((s72, 4096), (4096, 1), torch.float16)
        return (buf5, buf6, reinterpret_tensor(buf4, (s72, 8, 128), (6144, 128, 1), 5120), reinterpret_tensor(buf7, (s72, 32, 128), (4096, 128, 1), 0), buf0, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg4_1 = rand_strided((512, 6144), (6144, 1), device='cuda:0', dtype=torch.int32)
    arg5_1 = rand_strided((32, 768), (768, 1), device='cuda:0', dtype=torch.int32)
    arg6_1 = rand_strided((32, 6144), (6144, 1), device='cuda:0', dtype=torch.float16)
    arg7_1 = rand_strided((0, ), (1, ), device='cuda:0', dtype=torch.int32)
    arg8_1 = rand_strided((8192, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg9_1 = rand_strided((131072, 128), (128, 1), device='cuda:0', dtype=torch.float16)
