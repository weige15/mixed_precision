...
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_2.run(buf10, buf1, arg7_1, arg16_1, 8192, 4096, stream=stream0)
del buf1, arg7_1, buf10, arg16_1
...
#   %add_77 : Tensor "f32[s72, 4096][4096, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_5, %convert_element_type_1), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            # Topologically Sorted Source Nodes: [to, add, to_3, to_1, add_2, pow_2, mean_1, add_3, rsqrt_1, mul_3, to_5, mul_4], Original ATen: [aten._to_copy, aten.add, aten.pow, aten.mean, aten.rsqrt, aten.mul]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_2.run(buf10, buf1, arg7_1, arg16_1, s72, 4096, stream=stream0)
            del arg16_1
            del arg7_1
            del buf1
        return (buf10, )
