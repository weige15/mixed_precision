...
with torch.cuda._DeviceGuard(0):
    stream0 = get_raw_stream(0)
stream0 = get_raw_stream(0)
buf2 = generate_example_value((8192, 4096), (4096, 1), 'cuda:0', torch.float16, 0, (8192, 4096))
arg6_1 = generate_example_value((8192, 4096), (4096, 1), 'cuda:0', torch.float16, 0, (8192, 4096))
arg5_1 = generate_example_value((4096,), (1,), 'cuda:0', torch.float16, 0, (4096,))
buf6 = generate_example_value((8192, 4096), (4096, 1), 'cuda:0', torch.float16, 0, (8192, 4096))
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_0.run(buf2, arg6_1, arg5_1, buf6, 8192, 4096, stream=stream0)
del arg5_1, buf6

stream0 = get_raw_stream(0)
buf7 = generate_example_value((8192, 28672), (28672, 1), 'cuda:0', torch.float16, 0, (8192, 28672))
buf10 = generate_example_value((8192, 14336), (14336, 1), 'cuda:0', torch.float16, 0, (8192, 14336))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_mul_silu_slice_1.run(buf7, buf10, 117440512, stream=stream0)
del buf7, buf10

stream0 = get_raw_stream(0)
buf11 = generate_example_value((8192, 4096), (4096, 1), 'cuda:0', torch.float16, 0, (8192, 4096))
arg13_1 = generate_example_value((4096,), (1,), 'cuda:0', torch.float16, 0, (4096,))
buf15 = generate_example_value((8192, 4096), (4096, 1), 'cuda:0', torch.float16, 0, (8192, 4096))
buf20 = generate_example_value((8192, 4096), (4096, 1), 'cuda:0', torch.float16, 0, (8192, 4096))
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_2.run(buf11, buf2, arg6_1, arg13_1, buf15, buf20, 8192, 4096, stream=stream0)
del buf2, arg6_1, buf11, arg13_1, buf15, buf20

stream0 = get_raw_stream(0)
buf16 = generate_example_value((8192, 6144), (6144, 1), 'cuda:0', torch.float16, 0, (8192, 6144))
arg17_1 = generate_example_value((8192,), (1,), 'cuda:0', torch.int64, 0, (8192,))
arg18_1 = generate_example_value((131072, 128), (128, 1), 'cuda:0', torch.float16, 0, (131072, 128))
buf17 = generate_example_value((8192, 32, 128), (4096, 128, 1), 'cuda:0', torch.float16, 0, (8192, 32, 128))
buf18 = generate_example_value((8192, 8, 128), (1024, 128, 1), 'cuda:0', torch.float16, 0, (8192, 8, 128))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_3.run(buf16, arg17_1, arg18_1, buf17, buf18, 33554432, 8388608, stream=stream0)
del buf16, arg17_1, arg18_1, buf17, buf18
...
# kernel path: /nfs/home/s314511048/mixed_precision/torchinductor_s314511048/6g/c6g3wuzzofxvxtlm3zsraeq2dishou3qmtei2pdiurse5a7jqh6d.py
...
# Graph fragment:
#   %mm : Tensor "f16[s72, 4096][4096, 1]cuda:0" = PlaceHolder[target=mm]
#   %arg6_1 : Tensor "f16[s72, 4096][4096, 1]cuda:0" = PlaceHolder[target=arg6_1]
#   %buf3 : Tensor "f32[s72, 1][1, s72]cuda:0" = PlaceHolder[target=buf3]
#   %arg5_1 : Tensor "f16[4096][1]cuda:0" = PlaceHolder[target=arg5_1]
#   %convert_element_type_2 : Tensor "f32[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm, torch.float32), kwargs = {})
#   %add_15 : Tensor "f32[s72, 4096][4096, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_2, %arg6_1), kwargs = {})
...
#   %convert_element_type_4 : Tensor "f16[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_25, torch.float16), kwargs = {})
#   %mul_30 : Tensor "f16[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_4, %arg5_1), kwargs = {})
#   return %buf3,%mul_30
triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_0 = async_compile.triton('triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_0', '''
import triton
import triton.language as tl
...
# kernel path: /nfs/home/s314511048/mixed_precision/torchinductor_s314511048/cm/ccmr4csqhzexort4t5tgvzk44fxlml2rkadxmpdvrbufdkqkfvbq.py
# Topologically Sorted Source Nodes: [getitem, silu, getitem_1, mul_2], Original ATen: [aten.slice, aten.silu, aten.mul]
# Source node to ATen node mapping:
#   getitem => slice_1
#   getitem_1 => slice_2
#   mul_2 => mul_52
#   silu => convert_element_type_7, convert_element_type_8, mul_47, sigmoid
# Graph fragment:
#   %mm_1 : Tensor "f16[s72, 28672][28672, 1]cuda:0" = PlaceHolder[target=mm_1]
#   %slice_1 : Tensor "f16[s72, 14336][28672, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mm_1, 1, 0, 14336), kwargs = {})
#   %convert_element_type_7 : Tensor "f32[s72, 14336][14336, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%slice_1, torch.float32), kwargs = {})
#   %sigmoid : Tensor "f32[s72, 14336][14336, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%convert_element_type_7,), kwargs = {})
#   %mul_47 : Tensor "f32[s72, 14336][14336, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_7, %sigmoid), kwargs = {})
#   %convert_element_type_8 : Tensor "f16[s72, 14336][14336, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_47, torch.float16), kwargs = {})
#   %slice_2 : Tensor "f16[s72, 14336][28672, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mm_1, 1, 14336, 9223372036854775807), kwargs = {})
#   %mul_52 : Tensor "f16[s72, 14336][14336, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_8, %slice_2), kwargs = {})
#   return %mul_52
triton_poi_fused_mul_silu_slice_1 = async_compile.triton('triton_poi_fused_mul_silu_slice_1', '''
import triton
import triton.language as tl
...
# kernel path: /nfs/home/s314511048/mixed_precision/torchinductor_s314511048/zx/czxmawpuagmacnx3zzkvgat2h27lh7ohxqfds64onn5qidenaiye.py
...
# Graph fragment:
#   %mm_2 : Tensor "f16[s72, 4096][4096, 1]cuda:0" = PlaceHolder[target=mm_2]
#   %mm : Tensor "f16[s72, 4096][4096, 1]cuda:0" = PlaceHolder[target=mm]
#   %arg6_1 : Tensor "f16[s72, 4096][4096, 1]cuda:0" = PlaceHolder[target=arg6_1]
#   %buf12 : Tensor "f32[s72, 1][1, s72]cuda:0" = PlaceHolder[target=buf12]
#   %arg13_1 : Tensor "f16[4096][1]cuda:0" = PlaceHolder[target=arg13_1]
#   %convert_element_type_2 : Tensor "f32[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm, torch.float32), kwargs = {})
#   %add_15 : Tensor "f32[s72, 4096][4096, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_2, %arg6_1), kwargs = {})
#   %convert_element_type_11 : Tensor "f32[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_2, torch.float32), kwargs = {})
#   %convert_element_type_3 : Tensor "f16[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_15, torch.float16), kwargs = {})
#   %add_77 : Tensor "f32[s72, 4096][4096, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_11, %convert_element_type_3), kwargs = {})
...
#   %convert_element_type_13 : Tensor "f16[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_78, torch.float16), kwargs = {})
#   %mul_83 : Tensor "f16[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_13, %arg13_1), kwargs = {})
#   %convert_element_type_12 : Tensor "f16[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_77, torch.float16), kwargs = {})
#   return %buf12,%mul_83,%convert_element_type_12
triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_2 = async_compile.triton('triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_2', '''
import triton
import triton.language as tl
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg2_1, (4096, 512), (512, 1))
        assert_size_stride(arg3_1, (32, 4096), (4096, 1))
        assert_size_stride(arg4_1, (32, 512), (512, 1))
        assert_size_stride(arg5_1, (4096, ), (1, ))
        assert_size_stride(arg6_1, (s72, 4096), (4096, 1))
        assert_size_stride(arg7_1, (4096, 3584), (3584, 1))
        assert_size_stride(arg8_1, (32, 28672), (28672, 1))
        assert_size_stride(arg9_1, (32, 3584), (3584, 1))
        assert_size_stride(arg10_1, (14336, 512), (512, 1))
        assert_size_stride(arg11_1, (112, 4096), (4096, 1))
        assert_size_stride(arg12_1, (112, 512), (512, 1))
        assert_size_stride(arg13_1, (4096, ), (1, ))
        assert_size_stride(arg14_1, (4096, 768), (768, 1))
        assert_size_stride(arg15_1, (32, 6144), (6144, 1))
        assert_size_stride(arg16_1, (32, 768), (768, 1))
        assert_size_stride(arg17_1, (s72, ), (1, ))
        assert_size_stride(arg18_1, (131072, 128), (128, 1))
        _xnumel = 4096*s72
        _xnumel = 1024*s72
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            # Topologically Sorted Source Nodes: [awq_dequantize], Original ATen: [_C.awq_dequantize]
            buf0 = torch.ops._C.awq_dequantize.default(arg2_1, arg3_1, arg4_1, 0, 0, 0)
            del arg2_1
            del arg3_1
            del arg4_1
            buf1 = buf0
            assert_size_stride(buf1, (4096, 4096), (4096, 1), 'torch.ops._C.awq_dequantize.default')
            assert_alignment(buf1, 16, 'torch.ops._C.awq_dequantize.default')
            del buf0
            buf2 = empty_strided_cuda((s72, 4096), (4096, 1), torch.float16)
            # Topologically Sorted Source Nodes: [view, matmul], Original ATen: [aten.view, aten.mm]
            extern_kernels.mm(reinterpret_tensor(arg0_1, (s72, 4096), (4096, 1), 0), buf1, out=buf2)
            del arg0_1
            del buf1
            buf6 = empty_strided_cuda((s72, 4096), (4096, 1), torch.float16)
            # Topologically Sorted Source Nodes: [to, add, pow_1, mean, add_1, rsqrt, mul, to_2, mul_1], Original ATen: [aten._to_copy, aten.add, aten.pow, aten.mean, aten.rsqrt, aten.mul]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_0.run(buf2, arg6_1, arg5_1, buf6, s72, 4096, stream=stream0)
            del arg5_1
            # Topologically Sorted Source Nodes: [awq_dequantize_1], Original ATen: [_C.awq_dequantize]
            buf4 = torch.ops._C.awq_dequantize.default(arg7_1, arg8_1, arg9_1, 0, 0, 0)
            del arg7_1
            del arg8_1
            del arg9_1
            buf5 = buf4
            assert_size_stride(buf5, (4096, 28672), (28672, 1), 'torch.ops._C.awq_dequantize.default')
            assert_alignment(buf5, 16, 'torch.ops._C.awq_dequantize.default')
            del buf4
            buf7 = empty_strided_cuda((s72, 28672), (28672, 1), torch.float16)
            # Topologically Sorted Source Nodes: [to, add, pow_1, mean, add_1, rsqrt, mul, to_2, mul_1, matmul_1], Original ATen: [aten._to_copy, aten.add, aten.pow, aten.mean, aten.rsqrt, aten.mul, aten.mm]
            extern_kernels.mm(buf6, buf5, out=buf7)
            del buf5
            del buf6
            # Topologically Sorted Source Nodes: [awq_dequantize_2], Original ATen: [_C.awq_dequantize]
            buf8 = torch.ops._C.awq_dequantize.default(arg10_1, arg11_1, arg12_1, 0, 0, 0)
            del arg10_1
            del arg11_1
            del arg12_1
            buf9 = buf8
            assert_size_stride(buf9, (14336, 4096), (4096, 1), 'torch.ops._C.awq_dequantize.default')
            assert_alignment(buf9, 16, 'torch.ops._C.awq_dequantize.default')
            del buf8
            buf10 = empty_strided_cuda((s72, 14336), (14336, 1), torch.float16)
            # Topologically Sorted Source Nodes: [getitem, silu, getitem_1, mul_2], Original ATen: [aten.slice, aten.silu, aten.mul]
            triton_poi_fused_mul_silu_slice_1_xnumel = 14336*s72
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_silu_slice_1.run(buf7, buf10, triton_poi_fused_mul_silu_slice_1_xnumel, stream=stream0)
            del buf7
            buf11 = empty_strided_cuda((s72, 4096), (4096, 1), torch.float16)
            # Topologically Sorted Source Nodes: [getitem, silu, getitem_1, mul_2, matmul_2], Original ATen: [aten.slice, aten.silu, aten.mul, aten.mm]
            extern_kernels.mm(buf10, buf9, out=buf11)
            del buf10
            del buf9
            buf15 = empty_strided_cuda((s72, 4096), (4096, 1), torch.float16)
            buf20 = empty_strided_cuda((s72, 4096), (4096, 1), torch.float16)
            # Topologically Sorted Source Nodes: [to, add, to_3, to_1, add_2, pow_2, mean_1, add_3, rsqrt_1, mul_3, to_5, mul_4, to_4], Original ATen: [aten._to_copy, aten.add, aten.pow, aten.mean, aten.rsqrt, aten.mul]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_2.run(buf11, buf2, arg6_1, arg13_1, buf15, buf20, s72, 4096, stream=stream0)
            del arg13_1
            del arg6_1
            del buf11
            # Topologically Sorted Source Nodes: [awq_dequantize_3], Original ATen: [_C.awq_dequantize]
            buf13 = torch.ops._C.awq_dequantize.default(arg14_1, arg15_1, arg16_1, 0, 0, 0)
            del arg14_1
            del arg15_1
            del arg16_1
            buf14 = buf13
            assert_size_stride(buf14, (4096, 6144), (6144, 1), 'torch.ops._C.awq_dequantize.default')
            assert_alignment(buf14, 16, 'torch.ops._C.awq_dequantize.default')
            del buf13
            buf16 = empty_strided_cuda((s72, 6144), (6144, 1), torch.float16)
            # Topologically Sorted Source Nodes: [to, add, to_3, to_1, add_2, pow_2, mean_1, add_3, rsqrt_1, mul_3, to_5, mul_4, matmul_3], Original ATen: [aten._to_copy, aten.add, aten.pow, aten.mean, aten.rsqrt, aten.mul, aten.mm]
            extern_kernels.mm(buf15, buf14, out=buf16)
            del buf14
            buf17 = reinterpret_tensor(buf15, (s72, 32, 128), (4096, 128, 1), 0); del buf15  # reuse
            buf18 = empty_strided_cuda((s72, 8, 128), (1024, 128, 1), torch.float16)
            # Unsorted Source Nodes: [], Original ATen: []
            triton_poi_fused_3_xnumel_0 = 4096*s72
            triton_poi_fused_3_xnumel_1 = 1024*s72
            stream0 = get_raw_stream(0)
            triton_poi_fused_3.run(buf16, arg17_1, arg18_1, buf17, buf18, triton_poi_fused_3_xnumel_0, triton_poi_fused_3_xnumel_1, stream=stream0)
            del arg17_1
            del arg18_1
            buf19 = buf2; del buf2  # reuse
        return (buf17, buf18, reinterpret_tensor(buf16, (s72, 8, 128), (6144, 128, 1), 5120), reinterpret_tensor(buf19, (s72, 32, 128), (4096, 128, 1), 0), buf20, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = 8192
    arg2_1 = rand_strided((4096, 512), (512, 1), device='cuda:0', dtype=torch.int32)
    arg3_1 = rand_strided((32, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg4_1 = rand_strided((32, 512), (512, 1), device='cuda:0', dtype=torch.int32)
    arg5_1 = rand_strided((4096, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg6_1 = rand_strided((8192, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg7_1 = rand_strided((4096, 3584), (3584, 1), device='cuda:0', dtype=torch.int32)
    arg8_1 = rand_strided((32, 28672), (28672, 1), device='cuda:0', dtype=torch.float16)
    arg9_1 = rand_strided((32, 3584), (3584, 1), device='cuda:0', dtype=torch.int32)
    arg10_1 = rand_strided((14336, 512), (512, 1), device='cuda:0', dtype=torch.int32)
    arg11_1 = rand_strided((112, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg12_1 = rand_strided((112, 512), (512, 1), device='cuda:0', dtype=torch.int32)
    arg13_1 = rand_strided((4096, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg14_1 = rand_strided((4096, 768), (768, 1), device='cuda:0', dtype=torch.int32)
    arg15_1 = rand_strided((32, 6144), (6144, 1), device='cuda:0', dtype=torch.float16)
    arg16_1 = rand_strided((32, 768), (768, 1), device='cuda:0', dtype=torch.int32)
    arg17_1 = rand_strided((8192, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg18_1 = rand_strided((131072, 128), (128, 1), device='cuda:0', dtype=torch.float16)
